    ...
    public partial class Frm_FAR : Form
    {
        ...
        private void Frm_FAR_Load(object sender, EventArgs e)
        {
            ...
            switch (Frm_Main.FAR_type)
            {
                case 0:
                    Tx_Find.Focus();
                    Tx_Find.Text = Frm_Main.rtxs[Frm_Main.target_rtx].SelectedText;
                    Tx_Find.SelectAll();
                    break;
                case 1:
                    Tx_Replace_1.Focus();
                    Tx_Replace_1.Text = Frm_Main.rtxs[Frm_Main.target_rtx].SelectedText;
        ...
        {
            RichTextBox rtb = Frm_Main.rtxs[Frm_Main.target_rtx];
